const PATHS = {
  ...
  // Chevron duplo — recolher/expandir a sidebar fixa (desktop/tablet).
  // `AppLayout.module.css` gira 180° via CSS quando recolhida, então um
  // path só cobre os dois estados.
